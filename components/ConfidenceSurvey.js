...
export default function ConfidenceSurvey({ scenario, onComplete, onClose }) {
  ...
  const questions = [
    {
      key: 'familiarity',
      title: `Q1. How familiar are you with vocabulary and slang related to this topic (e.g., ${scenario?.title})?`,
      options: [
    ...
    {
      key: 'confidence',
      title: 'Q2. How confident are you in having a small talk or conversation in this situation?',
      options: [
      ...
      <div className="bg-white rounded-lg max-w-md w-full p-6 relative">
        ...
        <div className="mb-6">
          <h2 className="text-lg font-semibold text-gray-800">
            Scenario: Survey ({questions.length} questions)
          </h2>
          <p className="text-sm text-gray-600 mt-2">
            The purpose of this survey is to keep track of your learning progress with this web app.
          </p>
        </div>
