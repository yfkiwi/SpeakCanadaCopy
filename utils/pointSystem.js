  ...
  export const calculateTotalPoints = (roleplayPoints = 0, vocabularyPoints = 0, videoPoints = 0, quizPoints = 0) => {
    return Math.min(roleplayPoints + vocabularyPoints + videoPoints +  quizPoints, 10);
  };
